                ...
                >
                    {context.firms.map((firm, index) => (
                        <Marker
                            key={index}
                            position={{
                                lat: parseFloat(firm.lat),
                                lng: parseFloat(firm.long),
                            }}
                            icon={`./assets/img/map/${firm.color}.svg`}
                            onMouseDown={() => {
                                setActiveMarker(firm);
                                handleUsers(firm.users, firm.ausers);
                            ...
                            <div>
                                <div>
                                    <img
                                        ...
                                        src={`${process.env.REACT_APP_SOURCE_URL}assets/img/logos/${activeMarker.logo}`}
                                        alt=""
                                    />
                                </div>
                                <div>
                                ...
                                <br />
                                <div>
                                    <span className="font-weight-bold font-size-13">
                                        [ {activeMarker.ausers} /{" "}
                                        {activeMarker.users} ]
                                    </span>
                                    &emsp;
